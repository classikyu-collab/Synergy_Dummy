...
export default function StudentHome() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: 520, margin: '0 auto', background: THEME.bg, fontFamily: "'Noto Sans KR', -apple-system, sans-serif", color: THEME.ink, minHeight: '100vh' }}>
      <div
        style={{
          position: 'relative',
      ...
      >
        ...
        <p style={{ fontSize: 19, fontWeight: 700, margin: '0 40px 4px 0', lineHeight: 1.4 }}>{profile.name} 학생, 오늘도 힘내봐요!</p>
        <p style={{ fontSize: 13.5, color: 'rgba(255,255,255,0.78)', margin: '0 0 16px' }}>
