...
function StudentHomeworkContent() {
  ...
  useEffect(() => {
    let cancelled = false
    supabase
      .rpc('get_student_homework_board', { p_student_id: studentId })
  ...
  return (
    <div style={{ position: 'relative', contain: 'layout', width: '100%', maxWidth: 520, margin: '0 auto', background: THEME.bg, fontFamily: "'Noto Sans KR', -apple-system, sans-serif", color: THEME.ink, minHeight: '100vh' }}>
      ...
      <StudentMenuDrawer open={open} onClose={closeMenu} classId={classId} studentId={studentId} active="homework" theme={THEME} />
    </div>
  )
}
